 ...
 */
class SearchCommunityLocationAdapter(private val foundCommunityList: MutableList<CommunityModel>, private val itemClick: (Int) -> Unit)
    : RecyclerView.Adapter<SearchCommunityLocationAdapter.SearchViewHolder>() {
